...
LOAD_BALANCER_IP = IPAddr('10.0.1.1')
...
class LoadBalancer (EventMixin):
  ...
  def __init__ (self, connection):
    ...
    self.servers = [
      self.Server('10.0.0.21', '00:00:00:00:00:21', 1),
      self.Server('10.0.0.22', '00:00:00:00:00:22', 2),
      self.Server('10.0.0.23', '00:00:00:00:00:23', 3)]
    self.last_server = 0
  ...
  def handle_request (self, packet, event):
    ...
    log.info("Recebendo de  %s <-> %s" % (packet.next.srcip, server.ip))
